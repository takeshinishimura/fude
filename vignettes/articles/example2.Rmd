...
```{r idai1, echo = TRUE, warning = FALSE, message = FALSE, dpi = 150}
...
```{r idai2, echo = TRUE, warning = FALSE, message = FALSE, dpi = 150}
...
```{r idai3, echo = TRUE, warning = FALSE, message = FALSE, dpi = 150}
ggplot() +
