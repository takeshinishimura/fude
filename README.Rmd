...
You can download the agricultural community boundary data corresponding to the Fude Polygon data you have from the MAFF website <https://www.maff.go.jp/j/tokei/census/shuraku_data/2020/ma/index.html>.
```{r eval = FALSE}
b <- get_boundary(d2)
```
...
ggplot() +
  ...
  theme_void()
```
```{r gogoshima, echo = FALSE, warning = FALSE, message = FALSE}
library(ggplot2)
library(dplyr)
